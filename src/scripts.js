  ...
  planetAge(planet, bornYear) {
    ...
    if (lifeResult > 0 ) {
      ...
      return `I am sorry. You should have already passed away! Your age in ${this.planet.name} is ${age}. You have lived more ${parseInt(Math.abs(lifeResult))} years. Your life expected to be ${lifeExpentancy}.`
    }
